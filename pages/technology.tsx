    ...
    <div className="min-h-screen w-full bg-technology-mobile md:bg-technology-tablet xl:bg-technology-desktop bg-cover bg-no-repeat">
      ...
      <Layout>
        <section className="text-white pt-6 lg:pt-16 text-center">
          ...
          <div className="lg:grid grid-cols-[1fr,700px,2fr]">
            ...
            <section className="space-x-4 py-5 md:pt-14 md:pb-11 order-1 lg:grid lg:grid-cols-1 lg:space-x-0 lg:w-20 gap-8">
              {content.technology.map((tech, index) => (
                <button
                  className={`font-bellefair text-base md:text-[24px] lg:text-heading4 w-10 h-10 md:w-16 md:h-16 lg:w-20 lg:h-20 rounded-full border-[1px] border-opacity-25 ${
                    currentIndex === index
